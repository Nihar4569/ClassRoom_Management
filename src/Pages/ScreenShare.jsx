...
export default function ScreenShare() {
  ...
  const [screenshareType, setScreenshareType] = useState('screen'); // screen, window, tab
    ...
    const fetchClassrooms = async () => {
      try {
        ...
        if (teacherData) {
          ...
          // This is a simplified approach - in production you'd have a more efficient way to track teacher's classes
          const allClassrooms = [];
  ...
  // Theme colors - all useColorModeValue calls at the top level
                ...
                <VStack spacing={6}>
                  ...
                  >
                    <VStack spacing={3} align="stretch">
                      ...
                      {roomMetadata?.classroom && (
                        <HStack justify="space-between">
                          <Text fontSize="sm">Classroom:</Text>
                          <Badge colorScheme="teal">
                            {classrooms.find(c => c.id === roomMetadata.classroom)?.name || roomMetadata.classroom}
                          </Badge>
                        </HStack>
                      )}
                      
                      {roomMetadata?.creatorName && (
                        <HStack justify="space-between">
                          <Text fontSize="sm">Created by:</Text>
                          <Text fontSize="sm">{roomMetadata.creatorName}</Text>
                        </HStack>
                      )}
                    </VStack>
                  </Box>
